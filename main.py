...
for moment_to_change in ['SRDUS','KM','JUPCOST','SINNOVPATUS','TO','GROWTH','sales_mark_up_US']:
...
if baseline == '102':
    moments_to_change = ['SRDUS','KM','JUPCOST','SINNOVPATUS','GROWTH','TO','sales_mark_up_US']
    parameters_to_change = ['rho','zeta','kappa','gamma']
if baseline == '104':
    moments_to_change = ['SRDUS','KM','JUPCOST','SINNOVPATUS','GROWTH','TO']
    parameters_to_change = ['rho','zeta','kappa','gamma']
