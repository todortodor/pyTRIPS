...
#     # {'baseline':'2000','variation': '2.0'},
#     # {'baseline':'2000','variation': '10.2'},
#     # {'baseline':'2000','variation': '10.3'},
...
#     p_opti = p_baseline.copy()
#     # p_opti = parameters()
#     # p_opti.load_run(f'coop_eq_direct_saves/{direct_save_path}_nash/')
#     # p_opti.load_run(f'coop_eq_direct_saves/{direct_save_path}_pop_weighted/')
...
#     solution_welfare = sol_opti.cons_eq_welfare.copy()
...
#                 corner_welfare = sol_corner.cons_eq_welfare[i]
...
#                 corner_welfare = dyn_sol_corner.cons_eq_welfare[i]
                
#                 print(corner_welfare,solution_welfare)
#                 if corner_welfare > solution_welfare[i]:
...
#     solution_welfare = sol_c.cons_eq_welfare.copy()
...
#     solution_welfare = dyn_sol.cons_eq_welfare.copy()
...
#     if save_directly:
#         direct_save_path = baseline_dic["baseline"] + '_' + baseline_dic['variation']
#         p_opti.write_params(f'coop_eq_direct_saves/dyn_{direct_save_path}_nash/')
...
for baseline_dic in baseline_dics:    
    ...
    p_opti = parameters()
    p_opti.load_run(f'coop_eq_direct_saves/dyn_{direct_save_path}_nash/')
