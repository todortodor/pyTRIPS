...
from solver_funcs import fixed_point_solver_double_diff_double_delta, find_coop_eq_double_diffusion
...
if __name__ == '__main__':
    for baseline_dic in baseline_dics:    
        ...
        # for aggregation_method in ['pop_weighted']:
            ...
            p_opti, sol_opti = find_coop_eq_double_diffusion(p_baseline,aggregation_method,
