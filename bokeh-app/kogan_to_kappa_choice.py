...
for run_params in runs_params:
    ...
    if new_run:
        ...
        # p.load_data('calibration_results_matched_economy/baseline_'+baseline_number+'_variations/1/')
    ...
    # m.load_run('calibration_results_matched_economy/baseline_'+baseline_number+'_variations/2.1/')
    ...
    commentary = 'kappa:'+str(run_params['kappa'])+',TO:'+str(run_params['TO_target'])+',KM:'+str(run_params['KM_target'])
    # commentary = ''
