...
import pandas as pd
import os
from solver_funcs import find_nash_eq_tariff_delta
...
if __name__ == '__main__':
    for baseline_dic in baseline_dics:    
        ...
        p_nash, sol_nash = find_nash_eq_tariff_delta(p_baseline,
        ...
        try:
            os.mkdir(f'opt_tariff_delta/{baseline}/scenario_1')
        except:
            pass
        p_nash.write_params(f'opt_tariff_delta/{baseline}/scenario_1/')
