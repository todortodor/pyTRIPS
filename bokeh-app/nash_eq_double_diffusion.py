...
import pandas as pd
import os
from solver_funcs import find_nash_eq_double_diffusion
...
if __name__ == '__main__':
    for baseline_dic in baseline_dics:    
        ...
        # p_baseline.nu[1] = 0.050125
        # p_baseline.nu_tilde[1] = 0.001
        
        p_nash, sol_nash = find_nash_eq_double_diffusion(p_baseline,lb_delta=lb_delta,ub_delta=ub_delta,method='fixed_point',
...
# 0.98296948 NU 0.0501 DELTA 12
# 0.98295675 NU 0.050125 DELTA 12
# 0.98554401 NU 0.05015 DELTA 0.07216096
# 0.98553230 NU 0.0502 DELTA 0.07201619
