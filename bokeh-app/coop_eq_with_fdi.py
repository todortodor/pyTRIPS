...
from solver_funcs import fixed_point_solver, find_coop_eq_with_fdi
...
if __name__ == '__main__':
    for baseline_dic in baseline_dics:    
        ...
        for aggregation_method in ['pop_weighted']:
            ...
            p_opti, sol_opti = find_coop_eq_with_fdi(p_baseline,aggregation_method,
