...
import pandas as pd
import os
from solver_funcs import find_nash_eq_tariff_coop_delta
...
baseline_dics = [
    {'baseline':'1040','variation': 'baseline'},
...
if __name__ == '__main__':
    for baseline_dic in baseline_dics:    
        ...
        method = 'fixed_point'
        aggregation_method = 'negishi'
        
        p_baseline = parameters()
        p_baseline.load_run(baseline_path)
        
        p_nash, sol_nash = find_nash_eq_tariff_coop_delta(p_baseline,aggregation_method=aggregation_method,
                         lb_tariff=lb_tariff,ub_tariff=ub_tariff,
                         method='fixed_point',
